...
export default function Home() {
  ...
  <main className="bg-zinc-900 flex flex-col items-center justify-between">
    ...
    <div className=" flex flex-col items-center justify-between px-20">
      <h1 className="text-blue-500 font-mono py-40 text-6xl ">Julkar Naine Reedoy</h1>
    </div>
    <div className="px-20">
    ...
    <div className="min-h-screen">
      <div className="flex flex-col items-center justify-between py-10 px-2 text-lg rounded-lg">
        <h1><br></br><br></br>
          <Link href="/SFU" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-2 rounded-full">Website about SFU campuses</Link>
        </h1><br></br>
      </div>
