  ...
  return (
    <>
      ...
      <main className="bg-zinc-900 flex flex-col items-center mx-30 xl:px-80 py-10 sm:mx-1 rounded-sm">
        <div className=" flex flex-col items-center px-10 sm:px-1 text-white font-mono py-10 text-center text-4xl">
        ...
        <div>
          <article className="font-mono text-neutral-50 bg-cyan-900 rounded-lg flex flex-col items-center text-start text-md">
            <div className="bg-red-900 rounded-lg p-10  m-10 ">
              <p>
                Hi, my name is Julkar and welcome to my page :)<br></br>I am a
                2nd year Computing Science Student at Simon Fraser University.{" "}
                <br></br>
              ...
              <p>
                ...
                <br></br>I have experience working with abstract data structures
                in C and C++.<br></br>
            ...
            <div>
              <div className="flex flex-col items-center  text-md rounded-lg">
                <h1>
                  ...
                  <br></br>
                  <Link
                    href="https://gunmack.github.io/archived/SFU"
                    className="block rounded-lg p-4 hover:bg-zinc-900 hover:shadow-lg "
                  >
                    <Image
                      src="/images/SFU.png"
                      alt="SFU"
              ...
              <div className="grid grid-cols-2  bg-cyan-900 rounded-lg">
                <div className=" flex items-center px-10 text-md rounded-lg">
                  <h1>
                    <Link
                      href="https://www.linkedin.com/in/julkar-naine-reedoy-211015217/"
                      target="_blank"
                      className="block   bg-cyan-900  rounded-lg p-4 hover:bg-red-500 hover:shadow-lg"
                    >
                      <Image
