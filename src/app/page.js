...
export default function Home() {
  ...
  return (
  <main className="bg-zinc-900 flex flex-col items-center justify-between min-h-screen">
        ...
        <div className='grid grid-cols-2 p-10 bg-green-900 rounded-lg'>
          <div className=" flex items-center  px-10 text-md rounded-lg">
            <h1>
              ...
              <Link href="https://www.linkedin.com/in/julkar-naine-reedoy-211015217/" target="_blank"  className="block border border-green-900 rounded-lg p-4 hover:bg-red-900 hover:shadow-lg">
          ...
          <div className="  flex items-center  px-10 text-lg rounded-lg">
            <h1> <br></br>
              <Link href="https://github.com/gunmack" target="_blank"  className="block border border-green-900 rounded-lg p-4 hover:bg-neutral-50 hover:shadow-lg">
