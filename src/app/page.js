...
//   const data = data_x;
//   // Check if the data object contains the datetime property
//   if ('datetime' in data) {
//     const datetime = data.datetime;
//     // Check if datetime is defined before slicing
//     if (datetime) {
//       // Extract time (HH:mm) from datetime string
//       const cTime = datetime.slice(11, 16);
//       setCurrentTime(cTime);
//     } else {
//       console.error('Datetime is undefined');
//     }
//   } else {
//     console.error('Datetime property not found in API response');
//   }
// } catch (error) {
