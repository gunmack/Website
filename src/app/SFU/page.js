    ...
    return(
      ...
      <h1 className="text-red-500 flex flex-lf justify-center font-bold text-xl"> Campuses </h1>
        <article className=" px-20 py-10 rounded-lg flex flex-lf justify-center">
          <h1>
            <Link href="https://www.sfu.ca/~jnr2/SFU1/Burnaby.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold px-5 py-2 rounded-full"> Burnaby Campus</Link>
          </h1>
          <h1> 
            <Link href="https://www.sfu.ca/~jnr2/SFU1/Vancouver.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold px-5 py-2 rounded-full"> Vancouver Campus</Link>
          </h1>
          <h1> 
            ...
            <Link href="https://www.sfu.ca/~jnr2/SFU1/Surrey.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-5 rounded-full"> Surrey Campus</Link>
          </h1>
        </article>
        ...
        <article className=" px-2 py-10 rounded-lg flex flex-lf justify-center">
          <h1>
            <Link href="https://www.sfu.ca/~jnr2/SFU1/BNResidence.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-2 rounded-full"> Burnaby Residence</Link>
          </h1>
          <h1> 
            <Link href="https://www.sfu.ca/~jnr2/SFU1/VNResidence.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-2 rounded-full"> Vancouver Residence</Link>
          </h1>
        </article><br></br><br></br>
        <footer>
        <p className="text-cyan-500 font-serif text-lg flex flex-col items-center justify-between px-2">All information sourced from <Link href="https://www.sfu.ca/" className='hover:bg-red-900 text-neutral-50 rounded-lg'>sfu.ca </Link> and 
        <Link href="https://en.wikipedia.org/wiki/Simon_Fraser_University" className='hover:bg-red-900 text-neutral-50 rounded-lg'> wikipedia.org</Link><br></br><br></br>
        Created by <Link href="https://www.gunmack.dev/" className='hover:bg-red-900 text-neutral-50 rounded-lg'>Julkar Naine Reedoy </Link></p> <br></br><br></br>
        </footer>
      </div>
    </main>
    )
