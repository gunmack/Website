...
const SFU = () => {
    return(
      ...
      <div className=" flex flex-col items-center justify-between px-40">
        <h1 className=" text-red-500 font-mono px-50 py-20 my-10 text-6xl ">Simon Fraser University (1965)</h1>
      </div>
      <div className="px-60">
        <article className="font-serif text-neutral-50 bg-cyan-900 px-40 py-10 rounded-lg flex flex-col items-center justify-between text-xl">
          <p>
      ...
      <h1 className="text-red-500 flex flex-lf justify-center font-bold text-xl"> Campuses </h1>
        <article className=" px-30 py-10 rounded-lg flex flex-lf justify-center">
          <h1>
            <Link href="https://www.sfu.ca/~jnr2/SFU1/Burnaby.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-10 rounded-full"> Burnaby Campus</Link>
          </h1>
          <h1> 
            <Link href="https://www.sfu.ca/~jnr2/SFU1/Vancouver.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-10 rounded-full"> Vancouver Campus</Link>
          </h1>
          <h1> 
            ...
            <Link href="https://www.sfu.ca/~jnr2/SFU1/Surrey.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-10 rounded-full"> Surrey Campus</Link>
          </h1>
        </article>
        <h1 className="text-red-500 flex flex-lf justify-center font-bold text-xl"> Residences </h1>
        <article className=" px-30 py-10 rounded-lg flex flex-lf justify-center">
          <h1>
            <Link href="https://www.sfu.ca/~jnr2/SFU1/BNResidence.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-10 rounded-full"> Burnaby Residence</Link>
          </h1>
          <h1> 
            <Link href="https://www.sfu.ca/~jnr2/SFU1/VNResidence.html" target="_blank" className="bg-red-900 hover:bg-red-400 text-white font-bold py-2 px-10 rounded-full"> Vancouver Residence</Link>
          </h1>
        </article><br></br><br></br>
        <footer>
        <p className='text-cyan-500 font-serif text-lg'>All information sourced from <a href="https://www.sfu.ca/">sfu.ca </a> and 
